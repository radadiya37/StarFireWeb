...
export const DepartmentUpdate = (props: IDepartmentUpdateProps) => {
  ...
  const { departmentEntity, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="starfirewebApp.department.home.createOrEditLabel">
            <Translate contentKey="starfirewebApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : departmentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="department-name">
                  <Translate contentKey="starfirewebApp.department.name">Name</Translate>
                </Label>
                <AvField
                  id="department-name"
                  type="text"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="department-description">
                  <Translate contentKey="starfirewebApp.department.description">Description</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="codeLabel" for="department-code">
                  <Translate contentKey="starfirewebApp.department.code">Code</Translate>
                </Label>
                <AvField
                  id="department-code"
                  type="text"
              ...
              <AvGroup check>
                <Label id="statusLabel">
                  <AvInput id="department-status" type="checkbox" className="form-check-input" name="status" />
                  <Translate contentKey="starfirewebApp.department.status">Status</Translate>
                </Label>
              </AvGroup>
