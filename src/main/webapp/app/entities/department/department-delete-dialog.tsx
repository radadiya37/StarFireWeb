...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="starfirewebApp.department.delete.question">
        <Translate contentKey="starfirewebApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
