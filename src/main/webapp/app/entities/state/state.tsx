...
export const State = (props: IStateProps) => {
  ...
  return (
    <div>
      <h2 id="state-heading">
        <Translate contentKey="starfirewebApp.state.home.title">States</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="starfirewebApp.state.home.createLabel">Create new State</Translate>
        </Link>
      </h2>
        ...
        {stateList && stateList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="starfirewebApp.state.home.notFound">No States found</Translate>
            </div>
          )
        )}
      </div>
