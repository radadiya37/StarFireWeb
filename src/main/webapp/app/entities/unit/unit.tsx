...
export const Unit = (props: IUnitProps) => {
  ...
  const { unitList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="unit-heading">
        <Translate contentKey="starfirewebApp.unit.home.title">Units</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="starfirewebApp.unit.home.createLabel">Create new Unit</Translate>
        </Link>
      </h2>
        ...
        {unitList && unitList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="starfirewebApp.unit.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="starfirewebApp.unit.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="starfirewebApp.unit.home.notFound">No Units found</Translate>
            </div>
          )
        )}
      </div>
