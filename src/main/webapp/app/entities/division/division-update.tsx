...
export const DivisionUpdate = (props: IDivisionUpdateProps) => {
  ...
  const { divisionEntity, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="starfirewebApp.division.home.createOrEditLabel">
            <Translate contentKey="starfirewebApp.division.home.createOrEditLabel">Create or edit a Division</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
