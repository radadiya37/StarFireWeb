...
export const DivisionDeleteDialog = (props: IDivisionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="starfirewebApp.division.delete.question">
        <Translate contentKey="starfirewebApp.division.delete.question" interpolate={{ id: divisionEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-division" color="danger" onClick={confirmDelete}>
