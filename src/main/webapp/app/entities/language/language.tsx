  ...
  return (
    <div>
      <h2 id="language-heading">
        <Translate contentKey="starfirewebApp.language.home.title">Languages</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="starfirewebApp.language.home.createLabel">Create new Language</Translate>
        </Link>
      </h2>
        ...
        {languageList && languageList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="starfirewebApp.language.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="starfirewebApp.language.home.notFound">No Languages found</Translate>
            </div>
          )
        )}
      </div>
