...
export class CountryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('starfirewebApp.country.delete.question'));
...
export default class CountryComponentsPage {
  ...
  async deleteCountry() {
    ...
    expect(await countryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/starfirewebApp.country.delete.question/);
