...
export class LanguageDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('starfirewebApp.language.delete.question'));
...
export default class LanguageComponentsPage {
  ...
  async deleteLanguage() {
    ...
    expect(await languageDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/starfirewebApp.language.delete.question/);
