...
export class AddressDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('starfirewebApp.address.delete.question'));
...
export default class AddressComponentsPage {
  ...
  async deleteAddress() {
    ...
    expect(await addressDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/starfirewebApp.address.delete.question/);
