...
export class DepartmentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('starfirewebApp.department.delete.question'));
...
export default class DepartmentComponentsPage {
  ...
  async deleteDepartment() {
    ...
    expect(await departmentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/starfirewebApp.department.delete.question/);
