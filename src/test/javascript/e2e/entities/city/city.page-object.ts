...
export class CityDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('starfirewebApp.city.delete.question'));
...
export default class CityComponentsPage {
  ...
  async deleteCity() {
    ...
    expect(await cityDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/starfirewebApp.city.delete.question/);
